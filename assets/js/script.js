...
// 25.Tooltip
    ...
    // document.getElementById("theme-form contact-form").addEventListener("submit", function(event) {
    //   event.preventDefault();


    //    let name = document.getElementById("name").value;
    //    let phone = document.getElementById("review").value;
    //    let message = document.getElementById("message").value;

    //    // Replace with your WhatsApp number in international format (without +)
    //     let whatsappNumber = "2348169378246";


    //      let url = `https://wa.me/${whatsappNumber}?text=Hello,%20my%20name%20is%20${encodeURIComponent(name)}.%0AMy%20phone%20is%20${encodeURIComponent(phone)}.%0A${encodeURIComponent(message)}`;
